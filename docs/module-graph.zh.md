...
flowchart TD
  ...
  subgraph group_client["packages/client"]
    ...
    pkg_client_ui_rlm["client-ui-rlm"]
  ...
  subgraph group_rlm["packages/rlm"]
    pkg_plugin_continual_harness["plugin-continual-harness"]
    pkg_plugin_rlm_compaction["plugin-rlm-compaction"]
    pkg_plugin_rlm_kernel["plugin-rlm-kernel"]
    pkg_plugin_rlm_loop["plugin-rlm-loop"]
    pkg_plugin_rlm_memory["plugin-rlm-memory"]
    pkg_plugin_rlm_moa["plugin-rlm-moa"]
    pkg_plugin_rlm_redact["plugin-rlm-redact"]
    pkg_plugin_rlm_store["plugin-rlm-store"]
    pkg_plugin_rlm_verifier["plugin-rlm-verifier"]
  end
  ...
  pkg_client_ui_rlm --> pkg_client_locale
  pkg_client_ui_rlm --> pkg_client_ui_tool
  pkg_client_ui_rlm --> pkg_invariants
  ...
  pkg_plugin_rlm_loop --> pkg_session
  pkg_plugin_rlm_loop --> pkg_tools
  ...
  pkg_plugin_continual_harness --> pkg_agent
  pkg_plugin_continual_harness --> pkg_commands
  pkg_plugin_continual_harness --> pkg_invariants
  pkg_plugin_continual_harness --> pkg_session
  pkg_plugin_continual_harness --> pkg_subagent
  pkg_plugin_continual_harness --> pkg_system_prompt
  pkg_plugin_rlm_compaction --> pkg_agent
  pkg_plugin_rlm_compaction --> pkg_compaction
  pkg_plugin_rlm_compaction --> pkg_compaction_basic
  pkg_plugin_rlm_compaction --> pkg_invariants
  pkg_plugin_rlm_compaction --> pkg_llm
  pkg_plugin_rlm_compaction --> pkg_session
  pkg_plugin_rlm_kernel --> pkg_agent
  pkg_plugin_rlm_kernel --> pkg_invariants
  pkg_plugin_rlm_kernel --> pkg_llm
  pkg_plugin_rlm_kernel --> pkg_session
  pkg_plugin_rlm_kernel --> pkg_subagent
  pkg_plugin_rlm_kernel --> pkg_tools
  pkg_plugin_rlm_memory --> pkg_agent
  pkg_plugin_rlm_memory --> pkg_commands
  pkg_plugin_rlm_memory --> pkg_invariants
  pkg_plugin_rlm_memory --> pkg_session
  pkg_plugin_rlm_memory --> pkg_subagent
  pkg_plugin_rlm_memory --> pkg_tools
  pkg_plugin_rlm_verifier --> pkg_agent
  pkg_plugin_rlm_verifier --> pkg_llm
  pkg_plugin_rlm_verifier --> pkg_session
  pkg_plugin_rlm_verifier --> pkg_subagent
  pkg_plugin_rlm_verifier --> pkg_tools
  ...
  pkg_plugin_rlm_moa --> pkg_agent
  pkg_plugin_rlm_moa --> pkg_commands
  pkg_plugin_rlm_moa --> pkg_invariants
  pkg_plugin_rlm_moa --> pkg_llm
  pkg_plugin_rlm_moa --> pkg_plugin_rlm_kernel
  pkg_plugin_rlm_moa --> pkg_session
  pkg_plugin_rlm_moa --> pkg_subagent
  pkg_plugin_rlm_moa --> pkg_tools
...
| [`plugin-rlm-redact`](../packages/rlm/plugin-rlm-redact) | `rlm` | — |
| [`plugin-rlm-store`](../packages/rlm/plugin-rlm-store) | `rlm` | — |
...
| [`client-ui-rlm`](../packages/client/ui-rlm) | `client` | [`client-locale`](../packages/client/locale), [`client-ui-tool`](../packages/client/ui-tool), [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`plugin-rlm-loop`](../packages/rlm/plugin-rlm-loop) | `rlm` | [`session`](../packages/core/session), [`tools`](../packages/core/tools) |
...
| [`plugin-continual-harness`](../packages/rlm/plugin-continual-harness) | `rlm` | [`agent`](../packages/core/agent), [`commands`](../packages/interaction/commands), [`invariants`](../packages/runtime-diagnostics/invariants), [`session`](../packages/core/session), [`subagent`](../packages/subagent/subagent), [`system-prompt`](../packages/core/system-prompt) |
| [`plugin-rlm-compaction`](../packages/rlm/plugin-rlm-compaction) | `rlm` | [`agent`](../packages/core/agent), [`compaction`](../packages/compaction/compaction), [`compaction-basic`](../packages/compaction/compaction-basic), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session) |
| [`plugin-rlm-kernel`](../packages/rlm/plugin-rlm-kernel) | `rlm` | [`agent`](../packages/core/agent), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`subagent`](../packages/subagent/subagent), [`tools`](../packages/core/tools) |
| [`plugin-rlm-memory`](../packages/rlm/plugin-rlm-memory) | `rlm` | [`agent`](../packages/core/agent), [`commands`](../packages/interaction/commands), [`invariants`](../packages/runtime-diagnostics/invariants), [`session`](../packages/core/session), [`subagent`](../packages/subagent/subagent), [`tools`](../packages/core/tools) |
| [`plugin-rlm-verifier`](../packages/rlm/plugin-rlm-verifier) | `rlm` | [`agent`](../packages/core/agent), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`subagent`](../packages/subagent/subagent), [`tools`](../packages/core/tools) |
...
| [`plugin-rlm-moa`](../packages/rlm/plugin-rlm-moa) | `rlm` | [`agent`](../packages/core/agent), [`commands`](../packages/interaction/commands), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`plugin-rlm-kernel`](../packages/rlm/plugin-rlm-kernel), [`session`](../packages/core/session), [`subagent`](../packages/subagent/subagent), [`tools`](../packages/core/tools) |
