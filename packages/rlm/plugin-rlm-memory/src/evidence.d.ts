 ...
 */
export declare function parseSource(source: string): SourceRef | null;
/**
 ...
 */
export declare function sourceLocatesInDialog(source: string, dialogTurns: ReadonlyArray<{
    content: string;
}>): boolean;
/**
 ...
 */
export declare function admitByEvidence(notes: readonly Note[], dialogTurns: ReadonlyArray<{
    content: string;
}>): Note[];
