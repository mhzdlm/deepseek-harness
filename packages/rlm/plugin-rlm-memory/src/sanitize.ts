 ...
 */
export function sanitizeTurns(turns: readonly CaptureTurn[]): CaptureTurn[] {
 ...
 */
export function renderDialogJsonl(turns: readonly CaptureTurn[]): string {
 ...
 */
export function renderDialogText(turns: readonly CaptureTurn[]): string {
